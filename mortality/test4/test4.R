...
filenames <- list.files(pattern="Test4_[0-9]*.Rdata", full.names=TRUE)
load(filenames[1])
...
ggsave(plot = test4, filename = "Test4.png", height = 11, width = 10, unit = "cm")

#########################################
########## Save model ###################
#########################################

save(modelOutput, test4, file = "Test4.Rdata")
