...
setwd("/scratch/bell/ymeiborg/ymeiborg_hornet_gd/mortality/test2")
...
input$winterMort <- 0.402 #winter mortality rate
...
input$strategy <- 3 #what targeting strategy to use 1 = neutral, 2 = male, 3 = female, 4 = both
...
input$pFunctionalRepair <- c(0.01, 0.078, 0.15) #probability a resistance allele forms after non-homologous end-joining.
...
save(modelOutput, file = "Test2.Rdata")
