...
filenames <- list.files(pattern="Test5_[0-9]*.Rdata", full.names=TRUE)
load(filenames[1])
...
ggsave(plot = test5, filename = "Test5.png", height = 11, width = 10, unit = "cm")

#########################################
########## Save model ###################
#########################################

save(modelOutput, test5, file = "Test5.Rdata")
