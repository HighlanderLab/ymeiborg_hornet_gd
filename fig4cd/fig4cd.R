...
setwd("/scratch/bell/ymeiborg/ymeiborg_hornet_gd/fig4cd")
...
save(modelOutput, file = "Fig4.Rdata")
...
fig4d <- ggplot(lastGenStats, aes(x = value, y = generation, col = condition)) +
  facet_wrap(. ~ name, scales = "free_x",
             labeller = labeller(name = label_wrap_gen(width = 16))) +
...
ggsave(plot = p, filename = "Fig4.png", height = 15, width = 25, unit = "cm")

save(modelOutput, fig4c, fig4d, file = "Fig4cd.Rdata")
