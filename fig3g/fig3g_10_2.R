...
input$pFunctionalRepair <- seq(0.165, 0.3, 0.015) #probability a resistance allele forms after non-homologous end-joining.
...
save(modelOutput, file = "Fig3g_10_2.Rdata")
