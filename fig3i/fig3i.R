...
filenames <- list.files(pattern="Fig3i_[0-9]*_[0-9].Rdata", full.names=TRUE)
load(filenames[1])
...
save(fig3i, file = "Fig3i.Rdata")
ggsave(plot = fig3i, filename = "Fig3i.png", height = 11, width = 10, unit = "cm")
