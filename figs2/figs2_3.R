...
input$cutRate <- 0.97 #propability CRISPR cuts the opposite DNA strand
input$pHMort <- 0.15 #mortality of gene drive carriers.
...
save(modelOutput, file = "FigS2_3.Rdata")
