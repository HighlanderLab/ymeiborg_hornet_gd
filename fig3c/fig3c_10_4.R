...
input$pnhej <- seq(0, 0.01, 0.001) #probability of non-homologous end joining, determines the resistance alleles (0.02 in mosquitos)
...
save(modelOutput, file = "Fig3c_10_4.Rdata")
