...
setwd("/scratch/bell/ymeiborg/fig2b")
...
save(modelOutput, file = "Fig2b.Rdata")
...
ggsave(plot = p1, filename = "Fig2b.png", height = 12, width = 20, unit = "cm")

fig2b <- p1 + PaperTheme
save(fig2b, file = "Fig2b_plot.Rdata")
