...
input$pnhej <- seq(0, 0.2, 0.01) #probability of non-homologous end joining, determines the resistance alleles (0.2 in mosquitos)
...
save(modelOutput, file = "FigS2b_10.Rdata")
