...
input$pnhej <- 0.2 #probability of non-homologous end joining, determines the resistance alleles (0.2 in mosquitos)
input$cutRate <- 1 #probability CRISPR cuts the opposite DNA strand
input$pHMort <- seq(0.275, 0.5, 0.025) #mortality of gene drive carriers.
...
save(modelOutput, file = "Fig3l_10_3.Rdata")
