...
setwd("/scratch/bell/ymeiborg/ymeiborg_hornet_gd/test")
...
input$p_functionalRepair <- 0.07 #probability a resistance allele forms after non-homologous end-joining.
