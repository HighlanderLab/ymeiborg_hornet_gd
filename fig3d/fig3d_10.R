...
input$pnhej <- seq(0, 0.5, 0.025) #probability of non-homologous end joining, determines the resistance alleles (0.02 in mosquitos)
...
save(modelOutput, file = "Fig3d_10.Rdata")
